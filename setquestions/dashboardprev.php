...
<body onload="firstmodal('firstModal')">
	<!--Preloader-->
    ...
    <div class="wrapper theme-4-active pimary-color-red box-layout">
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<ul id="dashboard_dr" class="">
						<li>
							<a href="javascript:void(0);" data-toggle="collapse" data-target="#ecom_dr"><div class="pull-left"><i class="zmdi zmdi-shopping-basket mr-20"></i><span class="right-nav-text">Examiners</span></div><div class="pull-right"><span class="label label-success">hot</span></div><div class="clearfix"></div></a>
						</li>
						<li>
							<a  href="index2.html">Demographic</a>
						</li>
            ...
            <div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h5 class="txt-dark">Select Activities</h5>
					</div>
					<!-- Breadcrumb -->
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body pa-0">
									<article class="col-item">
										<div class="photo">
											<div class="options">
												<a href="examiners.php" class="font-18 txt-grey mr-10 pull-left"><i class="zmdi zmdi-edit"></i></a>
										...
										<div class="info">
											...
											<span class="head-font block text-warning font-16">Review Tests</span>
										</div>
									</article>
								</div>
							</div>	
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body pa-0">
									<article class="col-item">
										...
										<div class="info">
											<h6>Send Test</h6>
											<span class="head-font block text-warning font-16">Set and release exam timetable</span>
										</div>
									</article>
								</div>
							</div>	
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body pa-0">
									<article class="col-item">
										...
										<div class="info">
											<h6>Results</h6>
											<span class="head-font block text-warning font-16">Review Students Results</span>
										</div>
									</article>
								</div>
							</div>	
				...
				<!-- set of modals for questions set -->
				
				
										
				<!-- return modal -->
				<!-- The Modal -->
				<div id="firstModal" class="allModal">

				  <!-- Modal content -->
				  <div class="allModal-content">
					<div class="allModalheading"><h5><span id="firstModaltitle"><i class="fa fa-bars"></i> &nbsp; WELCOME!  <?php echo $name ; ?></span> <span class="close">x</span></h5></div>
					<hr />
					<p id="firstModaltext">Would you like to start settin new questions or continue with previous ones</p>
					<hr>
					<div class="allModalfoter" id="firstModalfooter" style="*float: right ;">
						<span><button class="btn btn-success btn-md" id="startnew" goto="secondModal">Start new</button></span>
						<span><button class="btn btn-primary btn-md">Continue</button></span>
					</div>
				  </div>
				...
				<!-- Form modal -->
				<div id="secondModal" class="allModal">

				  <!-- Modal content -->
				  <div class="allModal-content">
					<div class="allModalheading"><h5><span id="formModaltitle"><i class="fa fa-bars"></i> &nbsp; WELCOME!  <?php echo $name ; ?></span> <span class="close">x</span></h5></div>
					<hr />
					<div id="secondModaltext">
						<form id="formModal" action="../handler/actionmanager.php" method="post">
							<div class="row" style="display: block ;" id="step1">
								<div class="col-md-6 col-md-offset-3">
									<div class="form-group">
										<label class="control-label mb-10">0Select a Subject</label>
										<select class="form-control" name="subject" data-placeholder="Choose a Subject" tabindex="1">
											<?php
												while($fetch = mysqli_fetch_assoc($get_subjects))
												{
													$sub_name = $fetch['sub_name'] ;
													$sub_id = $fetch['sub_id'] ;
											?>
											<option value="<?php echo $sub_name ; ?>" name="<?php echo $sub_name ; ?>"> <?php echo $sub_name ; ?> </option>
											<?php
												}
											?>
							...
							<div class="row" style="display: none ;" id="step2">
								<div class="col-md-6 col-md-offset-3">
									<div class="form-group">
										<label class="control-label mb-10">1Select a Class</label>
										<select class="form-control" name="klass" data-placeholder="Choose a Subject" tabindex="1">
											<option value="JSS1" name="JSS1">JSS1</option>
											<option value="JSS2" name="JSS2">JSS2</option>
											<option value="JSS3" name="JSS3">JSS3</option>
											<option value="SSS1" name="SSS1">SSS1</option>
											<option value="SSS2" name="SSS2">SSS2</option>
											<option value="SSS3" name="SSS3">SSS3</option>
										</select>
									</div>
								</div>
							</div>
							<div class="row" style="display: none ;" id="step3">
								<div class="col-md-6 col-md-offset-3">
									<div class="form-group">
										<label class="control-label mb-10">2Select the appropriate option</label>
										<select class="form-control" name="type" data-placeholder="Choose a Subject" tabindex="1">
											<option value="Promotion Examination" name="JSS1">This question is for <b>Promotion Examination</b></option>
											<option value="Entrance Examination" name="JSS1">This Exam is for <b>Entrance Examination</b></option>
										</select>
									</div>
								</div>
							</div>
							<div class="row" style="display: none ;" id="step4">
								<div class="col-md-6 col-md-offset-3">
									<div class="form-group">
										<label class="control-label mb-10">3Password<span class="help-block">Please enter a security pass to secure this question</span></label>
										<input class="form-control" name="pword" type="password" data-placeholder="Password" id="quepass" /> <span id="togglepass" style="color: blue ; text-decoration: underline ; cursor: pointer;" class="link">show</span>
	
									</div>
								</div>
							</div>
							<div class="row" style="display: none ;" id="step5">
								<div class="col-md-6 col-md-offset-3" id="formBin">step 4
								</div>
							</div>
						</form>
					</div>
					<hr>
					<div class="allModalfoter" id="secondModalfooter" style="*float: right ;">
						<button class="btn btn-primary btn-md navbtn disabled" disabled="true" id="prevbtn">Previous <i class="fa fa-backward"></i></button>
						<button class="btn btn-success btn-md navbtn" disabled="true" id="nextbtn">Next <i class="fa fa-forward"></i></button>
						<button class="btn btn-primary btn-md navbtn" style="display: none ;" id="viewbtn">Preview <i class="fa fa-backward"></i></button>
						<button type="submit" class="btn btn-primary btn-md subbtn" id="subModalform" style="display: none ;" id="saveNew">Finish <i class="fa fa-backward"></i></button>
						<button type="button" class="btn btn-success btn-icon left-icon mr-10 pull-left loadingbtn" style="display:none ;"> <div class="loader"></div> </button>
					</div>
				  </div>
				...
				<!-- end of modals set for questions set -->
