					...
					<div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="card-box">
                                        ...
                                        <div class="card-box table-responsive">
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    <th>Name</th>
                                                    <th>Matric No</th>
                                                    <?php if($course == "all"){ ?><th>Course</th><?php } ?>
                                                    <th>Score</th>
                                                    <th>Percentage</th>
                                                    <th>Grade</th>
                                ...
                                <?php
                                // echo $getScores ;
                                        foreach ($getScores as $row) {
                                            $opt = $row['answers'] ;
                                            $num = count(explode('+=+,_', $opt))-1 ;
                                ?>
                                                <tr>
                                                    <td><?php echo $row['username']; ?></td>
                                                    <td><?php echo $row['matric']; ?></td>
                                                    <?php if($course == "all"){ ?><td><?php echo $row['course']; ?></td><?php } ?>
                                                    <td><?php echo $row['score']; ?></td>
                                                    <td><?php echo $row['percent']; ?></td>
                                                    <td><?php echo getGrade($row['percent']); ?></td>
                                                    <td><?php echo $num ; ?></td>
                                                </tr>
                                <?php
                                        } 
